...
import { lifecycleObservationHandler } from './lifecycle-observation.js';
...
const handlers: Record<EventType, EventHandler> = {
  ...
  'lifecycle-observation': lifecycleObservationHandler
};
...
export { lifecycleObservationHandler } from './lifecycle-observation.js';
